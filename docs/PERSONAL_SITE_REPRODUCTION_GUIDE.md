...
- one shared music bar with the same order and dimensions on every sibling site: queue, current track, a text-labeled `Shuffle` button, previous, play/pause, next, and the one-question AI control;
