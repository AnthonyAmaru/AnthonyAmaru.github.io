...
| 2026-08-08 | Writing disappeared from the Mandarin section menu after opening Quiz. | The notebook and Quiz duplicated their navigation markup, and the Quiz copy omitted Writing while also retaining outdated Home/Plans labels. | Mandarin notebook and Quiz expose the same study destinations and labels; lesson buttons precede the shared Cards, Sounds, Words, Writing, Practice, and Quiz controls. | Open Quiz directly and from every notebook page; confirm Lesson 1, Lesson 2, Cards, Sounds, Words, Writing, Practice, and Quiz are present exactly once. |
